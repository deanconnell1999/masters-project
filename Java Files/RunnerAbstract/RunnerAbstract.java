...
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyClassification;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMultipleHeuristic;
...
public abstract class RunnerAbstract {
	...
	protected void initLogOutput(
		...
		if (isEnableOutput() && outputToFile) {
			...
			File file = new File(outputFolder + "/log/"
					+ getExperimentName(workload, vmAllocationPolicy, vmSelectionPolicy) + ".txt");
			file.createNewFile();
	...
	protected PowerVmSelectionPolicy getVmSelectionPolicy(String vmSelectionPolicyName) {
		...
		} else if (vmSelectionPolicyName.equals("mh")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMultipleHeuristic();
		} else if (vmSelectionPolicyName.equals("cl")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyClassification();
